...
export default function TasksPage() {
  ...
  const filteredTasks = useMemo(() => {
    return (tasksData as Task[]).filter((task) => {
      const matchesSearch =
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24 lg:py-32">
          <div className="text-center space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight">
              ...
              <span className="block text-white">طبّق اللي اتعلمته</span>
            </h1>

            <p className="text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto">
              المهام دي مصممة عشان تختبر مستواك الحقيقي وتجهزك لسوق العمل.
            </p>
            ...
            <h6 className="text-xl sm:text-2xl font-bold">
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400">
                TRAIN YOURSELF TO GAIN EXPERIENCE
              </span>
            </h6>
      ...
      <div className="relative max-w-7xl mx-auto px-4 pb-20 z-10">
        {filteredTasks.length === 0 ? (
          <div className="text-center py-32">
            ...
            <p className="text-2xl text-slate-400">لا توجد مهام تطابق البحث</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {filteredTasks.map((task) => (
              ...
              >
                ...
                <p className="text-slate-400 mb-4">{task.brief}</p>
                ...
                <div className="border-t border-slate-800 pt-5 flex flex-col gap-2">
                  <a
                    href={task.docLink}
                    target="_blank"
